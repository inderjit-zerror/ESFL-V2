              ...
              >
                {item.href ? (
                  ...
                  <span
                    ...
                    className="Paragraph_Medium HNR_FONT group flex flex-col cursor-pointer"
                  >
                    <span className="flex items-center gap-1">
                      {item.name}
                      <ChevronDown
                  ...
                  <div className="min-w-[220px] rounded-md border border-white/10 bg-black/95 py-2 shadow-lg backdrop-blur-md">
                    {item.children.map((child) =>
                      child.href ? (
                        ...
                        <span
                          key={child.name}
                          className="Paragraph_Medium HNR_FONT block px-5 py-2.5 text-white/80 transition-colors duration-150 hover:text-white hover:bg-white/5 cursor-pointer"
                        >
                          {child.name}
                        </span>
                      )
        ...
        <nav className="flex max-h-[calc(100vh-70px-0.75rem)] flex-col gap-1 overflow-y-auto bg-black/95 px-6 py-6 backdrop-blur-md">
          {navLinks.map((item) =>
            item.children ? (
                    ...
                    <div className="flex flex-col gap-1 pb-3 pl-4">
                      {item.children.map((child) =>
                        child.href ? (
                          ...
                          <span
                            key={child.name}
                            className="Paragraph_Medium HNR_FONT py-2 text-white/70 transition-colors duration-150 hover:text-white cursor-pointer"
                          >
                            {child.name}
                          </span>
                        )
              ...
              <span
                key={item.name}
                className="Paragraph_Medium HNR_FONT border-b border-white/10 py-4 text-white last:border-b-0 cursor-pointer"
              >
                {item.name}
              </span>
            )
