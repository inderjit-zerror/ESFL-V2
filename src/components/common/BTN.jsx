...
const BTN = ({ txt, variant = "B1" }) => {
  const isB2 = variant === "B2";

  return (
    <button
      className={`group relative capitalize inline-flex h-10 items-center justify-center rounded-full  pl-4 pr-10  ${isB2 ? "bg-[#FFC55C] text-white!" : "bg-[#E30713] text-[#E30713]!"
        }`}
    >
      <span
