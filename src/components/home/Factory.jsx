...
const Factory = () => {
  return (
    <div className='w-full aspect-square sm:h-svh overflow-hidden flex bg-black relative'>
      ...
      <div className='w-full h-full absolute top-0 left-0 z-20 bg-black/30 p-5 sm:px-10 sm:pt-30'>
        <h1 className='Heading_1 max-sm:text-[1.5rem]! max-sm:leading-[1.5rem]! capitalize HNM_FONT text-white '>
