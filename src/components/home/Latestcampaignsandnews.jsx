          ...
          <Carousel
            ...
            renderItem={(item) => (
              <div className="group relative aspect-[4/3]  rounded-xl overflow-hidden">
                ...
                <span
                  className={`absolute top-3 sm:top-4 Paragraph_Small HNR_FONT text-[0.7rem]! left-3 sm:left-4 rounded-full px-3 py-1 tracking-widest ${item.badgeColor}`}
                >
                  {item.badge}
                </span>

                <div className="absolute bottom-5 sm:bottom-10 left-5 sm:left-10 right-5 sm:right-10 text-white">
                  {item.meta && (
                    <p className="Paragraph_Small MNR_FONT mb-3 sm:mb-5 ">
                      {item.meta}
                    </p>
                  )}
                  <p className="Paragraph_Medium text-[1.1rem]! sm:text-[1.5rem]! leading-[1.2rem]! sm:leading-[1.5rem]! MNH_FONT font-semibold! uppercase max-w-full sm:max-w-[70%] md:max-w-[50%]">
                    {item.title}
                  </p>
                </div>
              </div>
