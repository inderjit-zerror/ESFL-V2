...
const CsrVision = () => {
    return (
        <section className="bg-[#D42E12] container py-24 relative overflow-hidden">
            ...
            <div className="w-full relative z-10 flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-5xl">
                    {cards.map((card, index) => (
                        <div
                            key={index}
                            className={`group relative bg-[#FAF8F5] transition-all duration-300 hover:bg-[#FFC55C] p-5 flex flex-col h-full min-h-[380px]  rounded-xl ${card.rotation} hover:rotate-0 hover:-translate-y-2 cursor-pointer border border-transparent`}
                        >
