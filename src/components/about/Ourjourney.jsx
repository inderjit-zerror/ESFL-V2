...
//           // Fill the bottom timeline line left -> right (drawn within 70vw)
//           gsap.set(progressFillRef.current, {
//             scaleX: self.progress,
//           });

//           // Light up year dots + reveal year labels one by one as we pass them
...
//         <div className="mx-auto w-[70vw] px-6">
    ...
    >
      <div className="flex h-full flex-col justify-center gap-10 py-10">
        ...
        <div className="mx-auto w-[90vw] px-6">
          {/* Line broken into segments — one per gap between years, with a
              small visible break between each */}
